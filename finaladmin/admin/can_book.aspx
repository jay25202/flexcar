<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="can_book.aspx.cs" Inherits="admin_Default" %>
    ...
    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <h4 class="card-title">Cancelled Booking Information</h4>
                                <form runat="server">
                                    </br>
                               <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="booking_id" DataSourceID="SqlDataSource2" class="table color-bordered-table info-bordered-table" CellPadding="4" ForeColor="#333333" GridLines="None">
