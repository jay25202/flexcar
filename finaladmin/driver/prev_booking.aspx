<%@ Page Title="" Language="C#" MasterPageFile="~/driver/driverMasterPage.master" AutoEventWireup="true" CodeFile="prev_booking.aspx.cs" Inherits="driver_Default" %>
    ...
    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <h4 class="card-title">Previous Booking</h4>
    <form id="form1" runat="server">
  </br>
          

                        <asp:GridView ID="GridView1" runat="server" class="table color-bordered-table info-bordered-table" AutoGenerateColumns="False" DataKeyNames="booking_id" DataSourceID="SqlDataSource_prev" CellPadding="4" ForeColor="#333333" GridLines="None">
