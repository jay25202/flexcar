<%@ Page Title="" Language="C#" MasterPageFile="~/visitor/visitorMasterPage.master" AutoEventWireup="true" CodeFile="vcar_checkout.aspx.cs" Inherits="visitor_Default" %>
                                    ...
                                    <div class="car-filter order-billing margin-top-0">
                                        <div class="heading-block text-left margin-bottom-0">
                                            ...
                                            <div class="pull-right checkout_login_btn">
												<ul>
													<li><a href="vLogin_Page.aspx">Login <i class="fa fa-arrow-right"></i></a>
													</li>
												</ul>
                                        ...
                                        <form class="billing-form" runat="server">
                                            ...
                                            <div class="checkbox car_checkout_chekbox">
                                                ...
                                                <a href="vtandc.aspx"><i class="fa fa-long-arrow-right"></i> &nbsp; Terms & Condition** </a>
                                            </div>
                                            <br />
                                            <br />
                                            <div class="col-md-12">
