<%@ Page Title="" Language="C#" MasterPageFile="~/visitor/visitorMasterPage.master" AutoEventWireup="true" CodeFile="vregister.aspx.cs" Inherits="visitor_Default" %>
                            ...
                            <div class="register_left_form">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <%--<asp:TextBox ID="txtlicexpdt" placeholder="Driving Licence Expiry Date" type="text" runat="server"></asp:TextBox>--%>
                                        <%--<input type="text" name="field-name" value="" placeholder="website" />--%>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <%--  <asp:TextBox ID="txtbdt" placeholder="Birthdate" type="text"  runat="server" Style="left: 0px; top: 0px"></asp:TextBox>
                                        <asp:CalendarExtender runat="server" Enabled="True" TargetControlID="txtbdt" ID="txtbdt_CalendarExtender"></asp:CalendarExtender>--%>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <%--<asp:Button ID="btnotp" runat="server"  Text="Verify Phone no" OnClick="btnotp_Click" />--%>
                                ...
                                <div class="login_btn_wrapper register_btn_wrapper login_wrapper register_wrapper_btn">
                                    ...
                                    <center><asp:Button ID="btnreg" runat="server" class="btn btn-primary login_btn" Text="Register" OnClick="btnreg_Click" ValidationGroup="reg" /><br /> <br /> </center>
                                </div>
