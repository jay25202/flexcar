<%@ Page Title="" Language="C#" MasterPageFile="~/user/HomeMasterPage1.master" AutoEventWireup="true" CodeFile="ucars.aspx.cs" Inherits="user_Default3" %>
        ...
        <asp:Repeater ID="Repeater1" runat="server" DataSourceID="SqlDataSource1">
            ...
            FilledStarCssClass="FilledStar" CurrentRating='<%# getstar(Eval("car_id").ToString())%>'>
                        ...
                        <div class="x_car_offer_img float_left">
                            <a href='ucar_details.aspx?id=<%# Eval("car_id") %>' ><img src='../car_images/<%# Eval("car_image") %>' alt="img" height="110px" width="190px"></a>
                        ...
                        <div class="x_car_offer_bottom_btn float_left">
                            <ul>
                                <li><a href='userhome.aspx'>Book now</a>
                                </li>
                                <li><a href='ucar_details.aspx?id=<%# Eval("car_id") %>'>Details</a>
                                </li>
                            </ul>
                        </div>
                    </div>
