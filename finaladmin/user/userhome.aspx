<%@ Page Title="" Language="C#" MasterPageFile="~/user/HomeMasterPage1.master" AutoEventWireup="true" CodeFile="userhome.aspx.cs" Inherits="userhome" %>
			...
			<div class="x_slider_form_main_wrapper float_left">
				...
				<div class="row">
					...
					<div class="col-md-24">
                        ...
                        <asp:Label ID="dtv" runat="server" Text="" ForeColor="red"></asp:Label>
                        <asp:Label ID="dtv1" runat="server" Text="" ForeColor="red"></asp:Label>
