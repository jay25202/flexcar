<%@ Page Title="" Language="C#" MasterPageFile="~/user/HomeMasterPage1.master" AutoEventWireup="true" CodeFile="car_booking.aspx.cs" Inherits="user_Default3" %>
        ...
        <div class="x_car_book_sider_main_Wrapper float_left">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="x_slider_form_input_wrapper float_left">
                                                ...
                                                <asp:TextBox ID="txtpickup" type="text" runat="server" placeholder="City, Airport, Station, etc." OnTextChanged="txtpickup_TextChanged"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="x_slider_form_input_wrapper float_left">
                                                ...
                                                <%--<input type="text" placeholder="City, Airport, Station, etc.">--%>
                                                <asp:TextBox ID="txtdrop" runat="server" type="text" placeholder="City, Airport, Station, etc." OnTextChanged="txtdrop_TextChanged"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-sec-header">
                                                ...
                                                <label class="cal-icon">
                                                    ...
                                                    <asp:TextBox ID="txtpickdate" type="date" runat="server" class="form-control datepicker" OnTextChanged="txtpickdate_TextChanged"></asp:TextBox>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-sec-header">
                                                <h3>Pick-up Time</h3>
                                                <asp:TextBox ID="pickuptime" runat="server" type="time" OnTextChanged="pickuptime_TextChanged"></asp:TextBox>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-sec-header">
                                                ...
                                                <label class="cal-icon">
                                                    Drop-Off Date
													<%--<input type="text" placeholder="Tue 16 Jan 2018" class="form-control datepicker">--%>
                                                    <asp:TextBox ID="txtdropdate" type="date" runat="server" class="form-control datepicker" OnTextChanged="txtdropdate_TextChanged"></asp:TextBox>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-sec-header">
                                                <h3>Drop-Off Time</h3>
                                                <asp:TextBox ID="dropofftime" runat="server" Type="time" OnTextChanged="dropofftime_TextChanged"></asp:TextBox>
                                            </div>
            ...
            FilledStarCssClass="FilledStar" CurrentRating='<%# getstar(Eval("car_id").ToString())%>'>
                                                                ...
                                                                <div class="x_car_offer_img float_left">
                                                                    <a href='car_detail_left.aspx?id=<%# Eval("car_id") %>'>
                                                                ...
                                                                <div class="x_car_offer_bottom_btn float_left">
                                                                    <ul>
                                                                        <li><a href='car_checkout.aspx?id=<%# Eval("car_id") %>'>Book now</a>
                                                                        </li>
                                                                        <li><a href='car_detail_left.aspx?id=<%# Eval("car_id") %>'>Details</a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </div>
