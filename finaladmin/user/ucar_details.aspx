<%@ Page Title="" Language="C#" MasterPageFile="~/user/HomeMasterPage1.master" AutoEventWireup="true" CodeFile="ucar_details.aspx.cs" Inherits="visitor_Default" %>
                ...
                <div class="x_avanticar_btn float_left">
                    <ul>
                        <li>
                            ...
                            <asp:HyperLink ID="HyperLink1" runat="server" ForeColor="Black" NavigateUrl="ucars.aspx"> Back <i class="fa fa-arrow-right"></i></asp:HyperLink>
                        </li>
                    </ul>
                </div>
            </div>
